    ...
    public class TreatmentData
    {
        ...
        private void loadDatasNetatmo(string filePath)
        {
            ...
            foreach (var netatmo in Listnetatmos)
            {
                ...
                {
                    List<Netatmo> dataNetatmos = dicNetatmos[netatmo.capteurId];
                    dataNetatmos.Add(netatmo);
                    dicNetatmos[netatmo.capteurId] = dataNetatmos;
                ...
                //WriteLine(dicNetatmos[netatmo.capteurId].Count);
            }
        }
    }
}